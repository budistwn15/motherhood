                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title pt-2">Silahkan isi form informasi di bawah ini</h3>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{route('informasis.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="gambar" id="gambar" class="dropify" data-allowed-file-extensions="jpg jpeg png webp" data-max-file-size-preview="3M">
                                    @error('gambar')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
